...
class ClientSettings:
    ...
    calibrations_dir: str = "assets/calibrations/"
    references_dir: str = "assets/references/"
    telemetry_dir: str = "assets/telemetry/"
    ...
    def from_env(cls) -> ClientSettings:
        ...
        return cls(
            ...
            calibrations_dir=os.getenv("HURGOR_CALIBRATIONS_DIR", defaults.calibrations_dir),
            references_dir=os.getenv("HURGOR_REFERENCES_DIR", defaults.references_dir),
            telemetry_dir=os.getenv("HURGOR_TELEMETRY_DIR", defaults.telemetry_dir),
