...
import sys
print("--- [HURGOR] Pipeline Dosyası Okundu, Başlatılıyor ---")
# sys.stdout.flush() # Çıktıyı anında göstermesi için
...
class ThreadedEdgePipeline:
    ...
    def _fatal(self, message: str) -> None:
        ...
        self.stop()
# threaded_pipeline.py dosyasının en sonuna ekle:
if __name__ == "__main__":
    try:
        main() # Mevcut ana fonksiyonun
    except Exception as e:
        import traceback
        traceback.print_exc()
        input("\n--- HATA OLUŞTU! Kapatmak için ENTER'a bas ---")